...
def report_metric(result_dict, run_dir=None, snapshot_path=None):
...
@register_metric
def pr50k5_full(opts):
    opts.dataset_kwargs.update(max_size=None, xflip=False)
    precision, recall = precision_recall.compute_pr(opts, max_real=200000, num_gen=50000, nhood_size=5, row_batch_size=10000, col_batch_size=10000)
    return dict(pr50k5_full_precision=precision, pr50k5_full_recall=recall)
